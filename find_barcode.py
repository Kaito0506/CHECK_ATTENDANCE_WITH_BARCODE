...
while True:
    ...
    # dimensions
    image = cv2.imread("images\kaito.jpg")
    ...
    mrz = image[y:y + h, x:x + w]
    new_width = int(w * 2)  # Adjust the scaling factor as needed
    new_height = int(h * 2)  # Adjust the scaling factor as needed
